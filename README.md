...
- 与其它优化整合包相比，一些基础的优化模组肯定少不了，但是删除了一些过于激进的以提升稳定性。
- 增加了一些优化体验的模组，例如Client Sorts（背包整理），Distant Horizons（遥远的地平线，默认关闭），Mouse Tweaks（鼠标手势）等。
- 更符合我们亚洲地区自己人的使用体验（caramelChat 输入法模组）。
...
- Adds quality-of-life mods to enhance the experience, such as Client Sorts, Distant Horizons (disabled by default), Mouse Tweaks, and more.
